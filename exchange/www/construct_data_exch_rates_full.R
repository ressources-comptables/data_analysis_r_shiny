...
saveRDS(exchange_rates_combined_sorted, file = "www/exchange_rates_combined_sorted.rds")

# Alternatively, save as a CSV if preferred
# write.csv(exchange_rates_combined_sorted, file = "www/exchange_rates_combined_sorted.csv", row.names = FALSE)


# Save information about min_date and max_date
# ----------------------------------------------

# Save min_date and max_date separately
date_info <- list(min_date = min_date, max_date = max_date)
saveRDS(date_info, file = "www/date_info.rds")

# Alternatively, you can save each separately if preferred
# saveRDS(min_date, file = "www/min_date.rds")
# saveRDS(max_date, file = "www/max_date.rds")
